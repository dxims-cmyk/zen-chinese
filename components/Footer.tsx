      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-center md:text-left">
            <p className="font-heading text-xl font-bold text-[#F9F6F2]">{siteConfig.name}</p>
        ...
        <div className="border-t border-[#F9F6F2]/5 mt-8 pt-6 text-center">
          <a href="https://ampm-media.vercel.app" target="_blank" rel="noopener noreferrer" className="text-[#F9F6F2]/20 text-xs hover:text-[#F9F6F2]/40 transition-colors font-body">
